  ...
  try {
    ...
    const systemMessage = {
      ...
      content: `TU ROL
        ...
        - Si el usuario no está siendo claro o no da suficiente información, pide que la aclare o que dé más detalles, antes de responder con una solución.
       ...
       Cancelar | editar | modificar vacaciones, permisos o incidencias de un empleado:
        ...
        Los trámites disponibles están disponibles para que el colaborador pueda realizar solicitudes de manera digital a través de la plataforma online.nommy.mx
